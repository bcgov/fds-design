...
import {classNames, SlotProvider, useFocusableRef, useResizeObserver, useStyleProps} from '../../utils';
...
export const SearchWithin = React.forwardRef(function SearchWithin(props: SpectrumSearchWithinProps, ref: FocusableRef<HTMLElement>) {
  ...
  let stringFormatter = useLocalizedStringFormatter(intlMessages, '../../searchwithin');
